    ...
    <div className="relative z-10 min-h-[80vh] flex items-center justify-center px-4 sm:px-6 py-12">
      <div className="w-full max-w-md car-card rounded-3xl p-8 sm:p-10 border border-grey-800 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-slate-400 mt-1">Sign in to manage and launch live polling rooms.</p>
        </div>
        ...
        <p className="text-center text-xs text-slate-400 mt-6">
          ...
          <Link to={`/register?redirect=${encodeURIComponent(redirect)}`} className="font-semibold text-alice-300 hover:text-white underline">
            Sign up
          </Link>
        </p>
      </div>
